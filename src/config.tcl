...
set ::env(DESIGN_NAME) scan_wrapper_341452019534398035
...
set ::env(VERILOG_FILES) "$::env(DESIGN_DIR)/user_module_341452019534398035.v \
$::env(DESIGN_DIR)/scan_wrapper_341452019534398035.v"
